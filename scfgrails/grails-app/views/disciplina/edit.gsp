...
<html>
    ...
    <body>
        ...
        <div id="edit-disciplina" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.disciplina}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.disciplina}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.disciplina}" method="PUT">
                <g:hiddenField name="version" value="${this.disciplina?.version}" />
                <fieldset class="form">
                    <f:all bean="disciplina"/>
                </fieldset>
