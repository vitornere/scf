...
<html>
    ...
    <body>
        ...
        <div id="show-disciplina" class="content scaffold-show" role="main">
            ...
            <f:display bean="disciplina" />
            <g:form resource="${this.disciplina}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.disciplina}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
