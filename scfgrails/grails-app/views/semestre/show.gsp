...
<html>
    ...
    <body>
        ...
        <div id="show-semestre" class="content scaffold-show" role="main">
            ...
            <f:display bean="semestre" />
            <g:form resource="${this.semestre}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.semestre}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
