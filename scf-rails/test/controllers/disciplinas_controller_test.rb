...
class DisciplinasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create disciplina" do
    assert_difference('Disciplina.count') do
      post disciplinas_url, params: { disciplina: { codigo: @disciplina.codigo, creditos: @disciplina.creditos, mencao: @disciplina.mencao, nome: @disciplina.nome, pre_requisito: @disciplina.pre_requisito, semestre_id: @disciplina.semestre_id } }
    end
  ...
  test "should update disciplina" do
    patch disciplina_url(@disciplina), params: { disciplina: { codigo: @disciplina.codigo, creditos: @disciplina.creditos, mencao: @disciplina.mencao, nome: @disciplina.nome, pre_requisito: @disciplina.pre_requisito, semestre_id: @disciplina.semestre_id } }
